...
class Alpaca {
  ...
  async getAccountDetails() {
    ...
    if(accountDetails.pattern_day_trader) {
      let dayTradingBuyingPower = math.evaluate('4 * (bignumber(a) - bignumber(b))', {a: accountDetails.last_equity, b: accountDetails.last_maintenance_margin}).toString();
  ...
  async getInitialBuyingPower() {
    ...
    let initialBuyingPower = accountDetails.effective_buying_power;
