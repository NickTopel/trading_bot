...
class TastyTrade {
  ...
  async getAccountDetails() {
    ...
    if(accountDetails['margin-or-cash'] === 'Margin') {
      let marginBuyingPower = math.evaluate('bignumber(a) / bignumber(b)', {a: portfolioValue, b: this.maintenanceMargin}).toString();
      let dayTradingBuyingPower = math.evaluate('bignumber(a) / bignumber(b)', {a: accountBalances['day-trade-excess'], b: this.maintenanceMargin}).toString();
    ...
    return {
      ...
      initial_buying_power_percent: '0.4',
      positions: positions
    }
  }
